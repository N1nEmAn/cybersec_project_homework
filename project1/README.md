...
─────────────┼─────────┼───────────┼─────────┼───────────
平均加速比    │   1.00x │    2.05x  │   0.98x │    0.91x
```

### 性能分析

🏆 **最佳性能**: 查找表优化实现 **2.05倍平均加速**

📈 **关键发现**:
- **查找表优化**: 在所有数据大小上稳定实现2倍以上加速
- **并行优化**: 性能随数据大小变化（大数据效果更好）
- **位运算优化**: 由于优化开销导致轻微性能下降
...
详细的性能报告请查看 [`PERFORMANCE.md`](PERFORMANCE.md)
